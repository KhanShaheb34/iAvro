...
+ (id)allocWithZone:(NSZone *)zone {
    ...
    return sharedInstance; //on subsequent allocation attempts return existing singleton
}
...
- (id)init {
    ...
    if (self) {
        // Open the file
        NSString *fileName = AvroResourcePathForFile(@"autodict", @"plist", [AutoCorrect class]);
